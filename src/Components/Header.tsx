          ...
          <div className="flex items-center">
            <div className="bg-white/90 rounded-lg p-1">
              <img
                ...
                className="h-12 w-auto object-contain transition-all duration-500 transform hover:scale-105 hover:brightness-110"
              />
            </div>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-6 border-t border-white/20">
            <nav className="flex flex-col space-y-4">
                <button onClick={() => handleNavClick("about")} className="text-black hover:text-primary/80 transition-colors py-2 bg-transparent border-none cursor-pointer">About</button>
                <button onClick={() => handleNavClick("services")} className="text-black hover:text-primary/80 transition-colors py-2 bg-transparent border-none cursor-pointer">Our Work</button>
                <button onClick={() => handleNavClick("get-involved")} className="text-black hover:text-white/80 transition-colors py-2 bg-transparent border-none cursor-pointer">Get Involved</button>
                <button onClick={() => handleNavClick("contact")} className="text-black hover:text-white/80 transition-colors py-2 bg-transparent border-none cursor-pointer">Contact</button>
